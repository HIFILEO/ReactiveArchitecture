...
import com.example.reactivearchitecture.application.ReactiveArchitectureApplication;
...
public class AppInjector {
     ...
     */
    public static ApplicationComponent init(ReactiveArchitectureApplication reactiveArchitectureApplication) {
