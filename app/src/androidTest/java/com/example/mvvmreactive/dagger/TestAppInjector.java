...
public class TestAppInjector {
    ...
    public static TestApplicationComponent init(TestMvvmExampleApplication testMvvmExampleApplication) {
        ...
        TestApplicationComponent testApplicationComponent = DaggerTestApplicationComponent.builder()
                .application(testMvvmExampleApplication)
                .build();
        testApplicationComponent.inject(testMvvmExampleApplication);

        testMvvmExampleApplication
